...
using SmallApi.Domain.Contracts;
using SmallApi.Domain.Infra.OracleObjects;
using SmallApi.Domain.Managers;
    ...
    public class Startup
    {
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseSwaggerUI(c =>
            {
                ...
                c.IndexStream = () => GetType().GetTypeInfo().Assembly.GetManifestResourceStream("SmallApi.swagger.index.html");
